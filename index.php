...
<title>Fantasy | Vehicle Rentals</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Wanna go on a ride ?</h1>
            <p>We have more than a thousand of vehicles for you to choose. </p>
            <a href="#find" class="btn">Read More <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<!-- Resent Cat-->
<section id="find" class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best One For You</h2>
      <p>With dozens of brands and hundreds of models available, choosing your favourite vehicle is a easy process. And we provide 24x7 services with exciting offers and many more. Stay tuned !</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-motorcycle" aria-hidden="true"></i>300+</h2>
            <p><b>Bikes On Road</b></p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
