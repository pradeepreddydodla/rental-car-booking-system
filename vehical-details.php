...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,Location,message,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:location,:message,:status)";
...
if($lastInsertId)
{
echo "<script>alert('Check in my bookings for confirmation. You will be notified once it is confirmed !');</script>";
}
else 
{
...
<title>Fantasy | Vehicle Details</title>
<!--Bootstrap -->
